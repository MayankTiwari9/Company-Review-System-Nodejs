...
const SearchedCompany = () => {
  ...
  return (
    <div>
      <form onSubmit={searchedCompanyHandler} className="p-6">
        <div className="sm:col-span-3">
          ...
          <div className="mt-2">
            <input
              ...
              value={company}
              required
              className="block w-1/4 rounded-md border-0 p-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            />
          </div>
        </div>
        <button
      ...
      <div className="bg-white py-15 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl my-4">
